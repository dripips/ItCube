...
$stmt->bindParam(':teacherId', $_SESSION['teacher_id'], PDO::PARAM_INT);
$stmt->execute();
...
<head>
    ...
    <script src="../codesnippet/plugin.js"></script>
    <script src="../ckeditor/plugins/easyimage/plugin.js"></script>
    <script src="../ckeditor/plugins/image2/plugin.js"></script> -->
</head>
<body>
    ...
    <div class="my-5">
        ...
        <form id="addLessonForm">
            ...
            <div class="form-group">
              ...
              <textarea id="lesson_content" name="lesson_content"></textarea>
            </div>
            <!-- <div class="form-group">
...
document.getElementById('addLessonForm').addEventListener('submit', function() {
    // Перед отправкой формы делаем textarea видимым
    document.getElementById('lesson_content').style.display = 'block';
});
$(document).ready(function() {
    $("#addLessonForm").submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "add_lesson_handler.php", // Обработчик на сервере
            data: {
